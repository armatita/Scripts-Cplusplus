...
{
	cout << "******************************************************\n";
	cout << "Starting sort by depth algorithm.\n";
	cout << "******************************************************\n";

	char conf[256]="sortdata.pin";
	...
	cout << "Depth columns is: " << col << endl;
	cout << "******************************************************\n";
	...
	cout << "Finished.\n";
	cout << "Sorting columns with reference to " << col << " ... ";
	sort_my_data(data,rows,columns,col,nodata);
	cout << "Finished.\n";
