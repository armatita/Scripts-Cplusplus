...
{
	cout << "******************************************************\n";
	cout << "Starting invert well polarity algorithm.\n";
	cout << "******************************************************\n";

	char conf[256]="invwell.pin";
	...
	cout << "Variable column is: " << x << endl;
	cout << "******************************************************\n";
	...
	cout << "Finished.\n";
	cout << "Inverting polarity on chosen column... ";
	int i;
	for (i=0;i<rows;i++){if(data[i][x-1]!=nodata){data[i][x-1]=data[i][x-1]*(-1);}}
	cout << "Finished.\n";
